...
export default function SocialShare() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="text-center md:text-left mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-base-200 pb-6">
        <div>
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">
            Social Share Studio
          </h1>
